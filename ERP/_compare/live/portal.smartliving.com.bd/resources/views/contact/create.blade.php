          ...
          <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('country', 'Bangladesh', ['class' => 'form-control', 'placeholder' => __('business.country')]); !!}
                </div>
            </div>
          </div>
          <div class="col-md-3">
...
<script>
    (function(){
        ...
        // Added '#quick_add_contact' selector to handle the "Sale -> Add Sale" popup
        var form = document.querySelector('#contact_add_form') || document.querySelector('#contact_edit_form') || document.querySelector('#quick_add_contact');
