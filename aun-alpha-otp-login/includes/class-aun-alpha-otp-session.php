...
class AUN_Alpha_OTP_Session {

	const COOKIE       = 'aun_alpha_otp_sess';
	const TRANSIENT    = 'aun_alpha_otp_';      // + token
	const RL_PHONE     = 'aun_alpha_otp_rlp_';  // + md5(phone)
	const RL_IP        = 'aun_alpha_otp_rli_';  // + md5(ip)
