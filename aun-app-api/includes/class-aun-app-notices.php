...
class AUN_App_Notices {
	...
	public static function vent_messages() {
		return array(
			...
			360 => array(
				'title'    => 'Important: blocked vents can burn out the display',
				'title_bn' => 'গুরুত্বপূর্ণ: ভেন্ট বন্ধ হলে ডিসপ্লে পুড়ে যেতে পারে',
				'body'     => "Your projector has been with you a year now.\n\nThere is still nothing to take out and wash — the optical engine is sealed. But the vents that keep the lamp cool have been drawing room air the whole time, and dust builds up in them.\n\nThis is the part worth taking seriously. Once the vents block, the projector cannot get rid of its own heat. The fan works harder, the picture dims, and if it keeps running that way the display can burn out for good. That is a major repair, and it comes on slowly enough that most people never notice until it is too late.\n\nFive minutes with a soft brush, twice a year, prevents all of it. This is the second of the two.",
				'body_bn'  => "এক বছর হলো আপনি প্রজেক্টরটি ব্যবহার করছেন।\n\nএখনও খুলে ধোয়ার মতো কিছু নেই — ভেতরের অপটিক্যাল অংশ সিল করা। কিন্তু ল্যাম্প ঠান্ডা রাখার ভেন্টগুলো সারা বছর ঘরের বাতাস টেনেছে, আর তাতে ধুলা জমেছে।\n\nএই বিষয়টি গুরুত্ব দিয়ে দেখা দরকার। ভেন্ট বন্ধ হয়ে গেলে প্রজেক্টর নিজের তাপ বের করতে পারে না। ফ্যানকে বেশি চাপ নিতে হয়, ছবি কম উজ্জ্বল হয়, আর এভাবে চলতে থাকলে ডিসপ্লে পুরোপুরি পুড়ে যেতে পারে। এটি একটি বড় মেরামত, আর সমস্যাটি এত ধীরে বাড়ে যে বেশিরভাগ মানুষ দেরি হয়ে যাওয়ার আগে বুঝতেই পারেন না।\n\nবছরে দুইবার, নরম ব্রাশ দিয়ে পাঁচ মিনিট — এতেই পুরো ঝুঁকিটা এড়ানো যায়। এটি সেই দুইবারের দ্বিতীয়বার।",
			),
		);
	}
