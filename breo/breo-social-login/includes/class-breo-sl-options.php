...
class BREO_SL_Options {

	const OPTION = 'breo_sl_options';
	...
	public static function defaults() {
		return array(
			...
			'shape'      => 'round',    // round | rounded | square (round = pill when wide)
			'size'       => 46,         // px
			'align'      => 'center',   // left | center | right
			'show_label' => 1,          // 1 = wide "Continue with …" buttons (Breo default)
	...
	public static function get( $key ) {
		$map = array(
			'google_client_secret' => 'BREO_SL_GOOGLE_CLIENT_SECRET',
			'facebook_app_secret'  => 'BREO_SL_FACEBOOK_APP_SECRET',
			'google_client_id'     => 'BREO_SL_GOOGLE_CLIENT_ID',
			'facebook_app_id'      => 'BREO_SL_FACEBOOK_APP_ID',
		);
