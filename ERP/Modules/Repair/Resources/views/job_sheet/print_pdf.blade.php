...
<div class="width-100 box mb-10">
	<div class="width-40 f-left" style="padding-top:25px;" align="center">
		@if(!empty(Session::get('business.logo')))
          <img src="{{ asset( 'uploads/business_logos/' . Session::get('business.logo') ) }}" alt="Logo" style="width: auto; max-height: 60px; margin: auto;">
        @endif
	</div>
	<div class="width-60 f-left" align="center">
