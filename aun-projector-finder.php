...
class AUN_Projector_Wizard {
    ...
    private static function score_to_pct( $score ) {
     ...
     */
    private static function generate_ai_summary( $usage, $lighting, $size, $throw, $ansi, $has_4k, $is_short_throw, $is_android_tv, $ram, $weight, $port_wt ) {
     ...
     */
    private static function generate_reasons( $usage, $lighting, $size, $throw, $ansi, $has_4k, $is_short_throw, $is_android_tv, $ram, $weight, $port_wt, $ansi_dim, $ansi_bright, $price, $budget, $bgt_entry, $bgt_mid ) {
        $r = [];
